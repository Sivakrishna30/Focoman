    ...
    return (
      <div className="flex h-full items-center justify-center p-6">
        <div className="text-center">
          <h2 className="text-xl font-bold text-text-primary">Marketplace Module Disabled</h2>
          <p className="mt-2 text-text-secondary">This module is not enabled for your studio. Please contact support to enable the Growth & Discovery module.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="flex-1 overflow-auto bg-surface-app p-6 sm:p-8">
      <div className="mx-auto max-w-3xl">
        <div className="mb-8">
          <h1 className="text-2xl font-extrabold text-text-primary">Marketplace Profile</h1>
